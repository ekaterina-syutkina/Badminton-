...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
		...
		<?php
                            $sdd_db_host='svce.ru'; // //адрес сервера бд (всё как в программе)
                            $sdd_db_name='volkovsema_newbя'; // ваша бд
		...
		<!--ТАБЫ-->
            <div class="col-md-2"> 
                <ul class="nav nav-pills nav-stacked" role="tablist" id="mainMenu">
                    <li class="active"><a href="/" class="active"><i class="glyphicon glyphicon-arrow-left"></i> Главная</a></li>
                </ul>
            </div>
            <!--//ТАБЫ-->
            <div class="col-md-10">
